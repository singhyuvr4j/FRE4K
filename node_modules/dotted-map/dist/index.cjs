...
const require_without_countries = require('./without-countries.cjs');
let proj4 = require("proj4");
proj4 = require_chunk.__toESM(proj4);
let _turf_boolean_point_in_polygon = require("@turf/boolean-point-in-polygon");
_turf_boolean_point_in_polygon = require_chunk.__toESM(_turf_boolean_point_in_polygon);

//#region src/countries.geo.json
...
//#endregion
exports.DottedMapWithoutCountries = require_without_countries;
exports.default = DottedMap;
